...
const I18N = {
  "zh-CN": {
    ...
    rewriteHintMockFetch: "Fetch 命中后不发送至服务器，直接返回填写内容；XHR 会正常发送并记录警告日志。",
  ...
  en: {
    ...
    rewriteHintMockFetch: "Matching Fetch requests return the entered content without reaching the server. XHR continues normally and is logged with a warning.",
    rewriteExampleReplace: "{\"code\":0,\"data\":{\"name\":\"Mock\"}}",
    rewriteExampleJsonMerge: "{\"data\":{\"role\":\"admin\"}}",
    rewriteExampleScript: "const data = JSON.parse(originalResponse);\ndata.role = \"admin\";\nreturn data;",
    rewriteExampleMockFetch: "{\"code\":0,\"data\":{\"source\":\"local\"}}",
  ...
  ja: {
    ...
    rewriteHintMockFetch: "一致した Fetch はサーバーへ送信せず直接返します。XHR は通常どおり送信され、警告ログを記録します。",
    rewriteExampleReplace: "{\"code\":0,\"data\":{\"name\":\"Mock\"}}",
    rewriteExampleJsonMerge: "{\"data\":{\"role\":\"admin\"}}",
    rewriteExampleScript: "const data = JSON.parse(originalResponse);\ndata.role = \"admin\";\nreturn data;",
    rewriteExampleMockFetch: "{\"code\":0,\"data\":{\"source\":\"local\"}}",
  ...
  ko: {
    ...
    rewriteHintMockFetch: "일치한 Fetch는 서버로 보내지 않고 즉시 반환합니다. XHR은 정상 전송되고 경고 로그가 기록됩니다.",
    rewriteExampleReplace: "{\"code\":0,\"data\":{\"name\":\"Mock\"}}",
    rewriteExampleJsonMerge: "{\"data\":{\"role\":\"admin\"}}",
    rewriteExampleScript: "const data = JSON.parse(originalResponse);\ndata.role = \"admin\";\nreturn data;",
    rewriteExampleMockFetch: "{\"code\":0,\"data\":{\"source\":\"local\"}}",
